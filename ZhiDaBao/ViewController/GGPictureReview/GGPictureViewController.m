...
@interface GGPictureViewController ()<SwipeViewDataSource,SwipeViewDelegate>

@property (strong , nonatomic)  SwipeView  *swipView;
@property (weak , nonatomic) IBOutlet UILabel *countLabel;
@end

@implementation GGPictureViewController
...
- (void)setupViews
{
    ...
    self.countLabel.text = [NSString stringWithFormat:@"%d/%d",(int)_currentIndex+1,(int)_dataArray.count];
